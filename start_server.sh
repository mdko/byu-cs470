...
./bin/bzrflag --world-size=800 --occgrid-width=8000 --world=maps/two_ls.bzw --default-posnoise=3 --respawn-time=240 --time-limit=240 --max-shots=3 --red-port=50100 --green-port=50101 --seed=1 --red-tanks=5 --green-tanks=1 $@ &
sleep 2
