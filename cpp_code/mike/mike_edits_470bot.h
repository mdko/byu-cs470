...
stack<coordinate_t> recursive_depth_first_search(int target_x, int target_y, int current_x, int current_y, grid_t obstacles, vector<vector<bool> * > * visited_locations, stack<coordinate_t> path_so_far);
