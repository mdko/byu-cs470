...
./bin/bzrflag --world-size=800 --world=maps/four_ls.bzw --default-posnoise=3 --respawn-time=240 --time-limit=240 --max-shots=3 --red-port=50100 --green-port=50101 --seed=1 --red-tanks=5 --green-tanks=12 --blue-tanks=0 --purple-tanks=0 $@ &
sleep 2
